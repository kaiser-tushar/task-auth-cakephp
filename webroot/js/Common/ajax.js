var UTILITY = {
    ...
    ajaxLoad: function (url, placeholder) {
        ...
        this.APP_XHR = $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                UTILITY.ajax_error(jqXHR.status, errorThrown);
            }
        });
    },
    ...
    UTILITY_dropdown: function (placeholder, data, empty_text) {
        // Data: id->value
        $(placeholder).empty();
    ...
    UTILITY_dropdown_map: function (placeholder, data, empty_text, selected_value) {
        // Data: id->value
        $(placeholder).empty();
        var options = "";
        if (empty_text != '')
    ...
    clearUTILITYForm: function (form_id) {
        $(':input', '#' + form_id)
    ...
    UTILITY_dropdown_map_with_title: function (placeholder, data, empty_text, selected_value,configuration) {
        // Data: id->value
        ...
        if(UTILITY.isEmpty(configuration.key) || UTILITY.isEmpty(configuration.value) || UTILITY.isEmpty(configuration.title)){
        ...
        $.each(data, function (i, v) {
            if(UTILITY.isEmpty(v[configuration.key]) || UTILITY.isEmpty(v[configuration.value])){
